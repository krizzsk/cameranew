...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2 extends SuspendLambda implements kotlin.jvm.b.p<d<? super R>, Continuation<? super kotlin.u>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2(c[] cVarArr, Continuation continuation, kotlin.jvm.b.r rVar) {
    ...
    public final Object invoke(d<? super R> dVar, Continuation<? super kotlin.u> continuation) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2) create(dVar, continuation)).invokeSuspend(kotlin.u.a);
    }
