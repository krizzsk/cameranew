...
public final class FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 implements d<T> {
    final /* synthetic */ kotlin.jvm.b.q a;
    final /* synthetic */ d b;

    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", f = "Limit.kt", i = {0}, l = {IjkMediaMeta.FF_PROFILE_H264_HIGH_444}, m = "emit", n = {"this"}, s = {"L$0"})
    ...
    public FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1(kotlin.jvm.b.q qVar, d dVar) {
        this.a = qVar;
        this.b = dVar;
    }
    ...
    */
    public java.lang.Object emit(T r5, kotlin.coroutines.Continuation<? super kotlin.u> r6) {
        ...
        L35:
            kotlin.j.b(r6)
            kotlin.jvm.b.q r6 = r4.a
            kotlinx.coroutines.flow.d r2 = r4.b
            r0.L$0 = r4
            r0.label = r3
            r3 = 6
