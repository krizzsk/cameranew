...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 implements d<T> {
    final /* synthetic */ kotlin.jvm.b.p a;
    final /* synthetic */ Ref$ObjectRef b;

    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", f = "Reduce.kt", i = {0, 0}, l = {IjkMediaMeta.FF_PROFILE_H264_HIGH_444}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})
    ...
    public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2(kotlin.jvm.b.p pVar, Ref$ObjectRef ref$ObjectRef) {
        this.a = pVar;
