...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements kotlin.jvm.b.p<kotlinx.coroutines.channels.n<? super Object>, Continuation<? super kotlin.u>, Object> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__DelayKt$debounceInternal$1$values$1(c<? extends T> cVar, Continuation<? super FlowKt__DelayKt$debounceInternal$1$values$1> continuation) {
    ...
    public final Object invoke2(kotlinx.coroutines.channels.n<Object> nVar, Continuation<? super kotlin.u> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$values$1) create(nVar, continuation)).invokeSuspend(kotlin.u.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            kotlin.j.b(obj);
            c<T> cVar = this.$this_debounceInternal;
