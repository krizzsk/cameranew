...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements kotlin.jvm.b.p<d<? super R>, Continuation<? super kotlin.u>, Object> {
    final /* synthetic */ c<T>[] $flowArray;
    ...
    public static final class AnonymousClass1 extends Lambda implements kotlin.jvm.b.a<T[]> {
        ...
        public AnonymousClass1(c<T>[] cVarArr) {
            super(0);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransform$7(c<T>[] cVarArr, kotlin.jvm.b.q<? super d<? super R>, ? super T[], ? super Continuation<? super kotlin.u>, ? extends Object> qVar, Continuation<? super FlowKt__ZipKt$combineTransform$7> continuation) {
    ...
    public final Object invoke(d<? super R> dVar, Continuation<? super kotlin.u> continuation) {
        return ((FlowKt__ZipKt$combineTransform$7) create(dVar, continuation)).invokeSuspend(kotlin.u.a);
    }
