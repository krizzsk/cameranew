...
public class ArrayReadWriteBuf implements ReadWriteBuf {
    ...
    public int getInt(int i2) {
        ...
        return (bArr[i2] & Draft_75.END_OF_FRAME) | (bArr[i2 + 3] << 24) | ((bArr[i2 + 2] & Draft_75.END_OF_FRAME) << 16) | ((bArr[i2 + 1] & Draft_75.END_OF_FRAME) << 8);
    }
    ...
    public short getShort(int i2) {
        byte[] bArr = this.buffer;
        return (short) ((bArr[i2] & Draft_75.END_OF_FRAME) | (bArr[i2 + 1] << 8));
    }
