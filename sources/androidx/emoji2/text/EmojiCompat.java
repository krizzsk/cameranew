...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i2, @IntRange(from = 0) int i3, @IntRange(from = 0) int i4, boolean z) {
            return charSequence;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        CharSequence process(@NonNull CharSequence charSequence, int i2, int i3, int i4, boolean z) {
