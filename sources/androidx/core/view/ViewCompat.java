...
public class ViewCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        static boolean dispatchNestedFling(@NonNull View view, float f2, float f3, boolean z) {
            return view.dispatchNestedFling(f2, f3, z);
        }

        @DoNotInline
        static boolean dispatchNestedPreFling(@NonNull View view, float f2, float f3) {
        ...
        @DoNotInline
        static void setZ(@NonNull View view, float f2) {
            view.setZ(f2);
        }
    ...
    private static class Api23Impl {
        ...
        @DoNotInline
        static void setScrollIndicators(@NonNull View view, int i2) {
            view.setScrollIndicators(i2);
        }

        @DoNotInline
        static void setScrollIndicators(@NonNull View view, int i2, int i3) {
    ...
    static class Api24Impl {
        ...
        @DoNotInline
        static boolean startDragAndDrop(@NonNull View view, @Nullable ClipData clipData, @NonNull View.DragShadowBuilder dragShadowBuilder, @Nullable Object obj, int i2) {
    ...
    static class Api26Impl {
        ...
        @DoNotInline
        static void addKeyboardNavigationClusters(@NonNull View view, Collection<View> collection, int i2) {
        ...
        @DoNotInline
        static View keyboardNavigationClusterSearch(@NonNull View view, View view2, int i2) {
