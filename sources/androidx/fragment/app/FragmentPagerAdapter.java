...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int i2) {
        ...
        if (findFragmentByTag != null) {
            ...
            VdsAgent.onFragmentTransactionAdd(fragmentTransaction2, id, findFragmentByTag, makeFragmentName, fragmentTransaction2.add(id, findFragmentByTag, makeFragmentName));
        }
