...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private int findBackStackIndex(@Nullable String str, int i2, boolean z) {
    ...
    public void attachController(@NonNull FragmentHostCallback<?> fragmentHostCallback, @NonNull FragmentContainer fragmentContainer, @Nullable final Fragment fragment) {
        ...
        if (this.mHost == null) {
            ...
            if ((fragmentHostCallback2 instanceof SavedStateRegistryOwner) && fragment == null) {
                ...
                savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.d
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void popBackStack(int i2, int i3, boolean z) {
        if (i2 >= 0) {
            enqueueAction(new PopBackStackState(null, i2, i3), z);
            return;
        }
        throw new IllegalArgumentException("Bad id: " + i2);
    }
