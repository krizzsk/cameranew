...
public abstract class FragmentTransaction {
    ...
    public final FragmentTransaction add(@NonNull Class<? extends Fragment> cls, @Nullable Bundle bundle, @Nullable String str) {
        ...
        FragmentTransaction add = add(createFragment, str);
        VdsAgent.onFragmentTransactionAdd(this, createFragment, str, add);
        return add;
    }
    ...
    public FragmentTransaction replace(@IdRes int i2, @NonNull Fragment fragment) {
        FragmentTransaction replace = replace(i2, fragment, (String) null);
        VdsAgent.onFragmentTransactionReplace(this, i2, fragment, null, replace);
        return replace;
    }
    ...
    public final FragmentTransaction add(@IdRes int i2, @NonNull Class<? extends Fragment> cls, @Nullable Bundle bundle) {
        Fragment createFragment = createFragment(cls, bundle);
        FragmentTransaction add = add(i2, createFragment);
        VdsAgent.onFragmentTransactionAdd(this, i2, createFragment, add);
        return add;
    }
    ...
    public final FragmentTransaction replace(@IdRes int i2, @NonNull Class<? extends Fragment> cls, @Nullable Bundle bundle, @Nullable String str) {
        Fragment createFragment = createFragment(cls, bundle);
        FragmentTransaction replace = replace(i2, createFragment, str);
        VdsAgent.onFragmentTransactionReplace(this, i2, createFragment, str, replace);
        return replace;
    }
    ...
    public final FragmentTransaction add(@IdRes int i2, @NonNull Class<? extends Fragment> cls, @Nullable Bundle bundle, @Nullable String str) {
        Fragment createFragment = createFragment(cls, bundle);
        FragmentTransaction add = add(i2, createFragment, str);
        VdsAgent.onFragmentTransactionAdd(this, i2, createFragment, str, add);
        return add;
    }
    ...
    public FragmentTransaction add(@NonNull ViewGroup viewGroup, @NonNull Fragment fragment, @Nullable String str) {
        ...
        FragmentTransaction add = add(id, fragment, str);
        VdsAgent.onFragmentTransactionAdd(this, id, fragment, str, add);
        return add;
    }
