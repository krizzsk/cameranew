...
public class ReportFragment extends Fragment {
    ...
    public static void injectIfNeededIn(Activity activity) {
        ...
        if (fragmentManager.findFragmentByTag(REPORT_FRAGMENT_TAG) == null) {
            ...
            FragmentTransaction add = beginTransaction.add(reportFragment, REPORT_FRAGMENT_TAG);
            VdsAgent.onFragmentTransactionAdd(beginTransaction, reportFragment, REPORT_FRAGMENT_TAG, add);
            add.commit();
