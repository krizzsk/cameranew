    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(6) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            protected void validateMigration(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                hashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(TapjoyAuctionFlags.AUCTION_ID)));
                hashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("prerequisite_id"), Arrays.asList(TapjoyAuctionFlags.AUCTION_ID)));
                ...
                if (tableInfo.equals(read)) {
                    ...
                    hashMap2.put(TapjoyAuctionFlags.AUCTION_ID, new TableInfo.Column(TapjoyAuctionFlags.AUCTION_ID, "TEXT", true, 1));
                    ...
                    if (tableInfo2.equals(read2)) {
                        ...
                        hashMap3.put(Issue.ISSUE_REPORT_TAG, new TableInfo.Column(Issue.ISSUE_REPORT_TAG, "TEXT", true, 1));
                        hashMap3.put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 2));
                        HashSet hashSet5 = new HashSet(1);
                        hashSet5.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(TapjoyAuctionFlags.AUCTION_ID)));
                        ...
                        if (tableInfo3.equals(read3)) {
                            ...
                            hashSet7.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(TapjoyAuctionFlags.AUCTION_ID)));
                            ...
                            if (tableInfo4.equals(read4)) {
                                ...
                                hashSet8.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(TapjoyAuctionFlags.AUCTION_ID)));
