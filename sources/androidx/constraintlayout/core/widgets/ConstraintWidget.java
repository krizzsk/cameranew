...
public class ConstraintWidget {
    ...
    */
    ...
    private void serializeSize(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f2, float f3) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, BigAlbumStore.PhotoColumns.SIZE, i2, Integer.MIN_VALUE);
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        getSceneString(sb, TJAdUnitConstants.String.LEFT, this.mLeft);
        getSceneString(sb, TJAdUnitConstants.String.TOP, this.mTop);
        getSceneString(sb, TJAdUnitConstants.String.RIGHT, this.mRight);
        getSceneString(sb, TJAdUnitConstants.String.BOTTOM, this.mBottom);
    ...
    public StringBuilder serialize(StringBuilder sb) {
        sb.append("{\n");
        serializeAnchor(sb, TJAdUnitConstants.String.LEFT, this.mLeft);
        serializeAnchor(sb, TJAdUnitConstants.String.TOP, this.mTop);
        serializeAnchor(sb, TJAdUnitConstants.String.RIGHT, this.mRight);
        serializeAnchor(sb, TJAdUnitConstants.String.BOTTOM, this.mBottom);
