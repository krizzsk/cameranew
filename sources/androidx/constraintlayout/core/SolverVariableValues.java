    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (variable != null) {
                ...
                String str3 = str2 + "[p: ";
                String str4 = (this.previous[indexOf] != -1 ? str3 + this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]] : str3 + PortalFollowFeeds.TYPE_NONE) + ", n: ";
                str = (this.next[indexOf] != -1 ? str4 + this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]] : str4 + PortalFollowFeeds.TYPE_NONE) + "]";
            }
        }
        return str + " }";
    }
