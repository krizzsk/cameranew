...
public class ConstraintLayout extends ViewGroup {
    ...
    public void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (i22 != -1) {
            ...
            if (i27 != -1) {
                setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i27, ConstraintAnchor.Type.BASELINE);
            } else {
                int i28 = layoutParams.baselineToTop;
                if (i28 != -1) {
                    setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i28, ConstraintAnchor.Type.TOP);
                } else {
                    int i29 = layoutParams.baselineToBottom;
                    if (i29 != -1) {
                        setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i29, ConstraintAnchor.Type.BOTTOM);
                    }
                }
            }
            if (f2 >= 0.0f) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.isGuideline || layoutParams.isHelper || layoutParams.isVirtualGroup || isInEditMode) && !layoutParams.isInPlaceholder) {
                ...
                if ((childAt instanceof Placeholder) && (content = ((Placeholder) childAt).getContent()) != null) {
                    ...
                    VdsAgent.onSetViewVisibility(content, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i2, int i3, int i4) {
        ...
        this.mMeasurer.captureLayoutInfo(i3, i4, max2, max3, paddingWidth, i5);
        if (Build.VERSION.SDK_INT >= 17) {
