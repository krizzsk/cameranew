...
public class ConstraintLayoutStates {
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i2 = 0; i2 < attributeCount; i2++) {
            ...
            if (attributeName != null && attributeValue != null && TapjoyAuctionFlags.AUCTION_ID.equals(attributeName)) {
                int identifier = attributeValue.contains("/") ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), TapjoyAuctionFlags.AUCTION_ID, context.getPackageName()) : -1;
                if (identifier == -1) {
