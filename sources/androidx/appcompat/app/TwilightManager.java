...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - AdvTimeUtils.MILLIS_OF_A_DAY, location.getLatitude(), location.getLongitude());
        ...
        boolean z2 = z;
        twilightCalculator.calculateTwilight(AdvTimeUtils.MILLIS_OF_A_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
