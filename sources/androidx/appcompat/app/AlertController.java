...
public class AlertController {
    ...
    static void manageScrollIndicators(View view, View view2, View view3) {
        ...
        if (view3 != null) {
            int i3 = view.canScrollVertically(1) ? 0 : 4;
    ...
    private void setupButtons(ViewGroup viewGroup) {
        ...
        Button button4 = (Button) viewGroup.findViewById(16908314);
        ...
        Button button7 = (Button) viewGroup.findViewById(16908315);
        this.mButtonNeutral = button7;
        button7.setOnClickListener(this.mButtonHandler);
        if (TextUtils.isEmpty(this.mButtonNeutralText) && this.mButtonNeutralIcon == null) {
            Button button8 = this.mButtonNeutral;
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        View findViewById2 = this.mWindow.findViewById(R.id.title_template);
