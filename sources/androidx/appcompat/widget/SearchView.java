...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        VdsAgent.onPendingIntentGetActivityShortBefore(context, 0, intent2, 1107296256);
        PendingIntent activity = PendingIntent.getActivity(context, 0, intent2, 1107296256);
        VdsAgent.onPendingIntentGetActivityShortAfter(context, 0, intent2, 1107296256, activity);
    ...
    private void updateSubmitArea() {
        int i2 = (isSubmitAreaEnabled() && (this.mGoButton.getVisibility() == 0 || this.mVoiceButton.getVisibility() == 0)) ? 0 : 8;
