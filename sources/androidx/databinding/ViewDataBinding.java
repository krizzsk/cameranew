...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    protected static ViewDataBinding bind(Object obj, View view, int i2) {
    ...
    protected static <T extends ViewDataBinding> T inflateInternal(@NonNull LayoutInflater layoutInflater, int i2, @Nullable ViewGroup viewGroup, boolean z, @Nullable Object obj) {
    ...
    */
    ...
    protected static void setTo(char[] cArr, int i2, char c) {
        if (cArr == null || i2 < 0 || i2 >= cArr.length) {
            return;
        }
        cArr[i2] = c;
