...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Draft_75.CR, 10, 26, 10};
    ...
    static {
        ...
        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(AdvTimeUtils.DATE_FORMAT_SEC_HYPHEN, locale);
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if ((Marker.ANY_NON_NULL_MARKER.equals(substring) || PGTransHeader.CONNECTOR.equals(substring)) && ":".equals(str3.substring(3, 4)) && parseInt <= 14) {
                        int i3 = ((parseInt * 60) + parseInt2) * 60 * 1000;
                        if (!PGTransHeader.CONNECTOR.equals(substring)) {
                            i2 = -1;
                        }
                        time += i3 * i2;
                    }
    ...
    */
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        if (this.mHasThumbnail) {
            if (this.mHasThumbnailStrips) {
                this.mAttributes[4].put(TAG_STRIP_OFFSETS, ExifAttribute.createUShort(i5, this.mExifByteOrder));
            } else {
                this.mAttributes[4].put(TAG_JPEG_INTERCHANGE_FORMAT, ExifAttribute.createULong(i5, this.mExifByteOrder));
            }
    ...
    public void setAttribute(@NonNull String str, @Nullable String str2) {
        ...
        if ((TAG_DATETIME.equals(str3) || TAG_DATETIME_ORIGINAL.equals(str3) || TAG_DATETIME_DIGITIZED.equals(str3)) && str4 != null) {
            ...
            if (str2.length() != 19 || (!find && !find2)) {
                ...
                str4 = str4.replaceAll(PGTransHeader.CONNECTOR, ":");
            }
        }
                    ...
                    switch (i2) {
                        ...
                        case 10:
                            ...
                            while (i13 < split6.length) {
                                ...
                                rationalArr2[i13] = new Rational((long) Double.parseDouble(split7[c]), (long) Double.parseDouble(split7[i4]));
                                i13++;
                                split6 = split6;
                                c = 0;
                                i4 = 1;
