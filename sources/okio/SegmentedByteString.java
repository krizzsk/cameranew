...
final class SegmentedByteString extends ByteString {
    ...
    public SegmentedByteString(b bVar, int i2) {
        super(null);
        l.b(bVar.b, 0L, i2);
        h hVar = bVar.a;
        int i3 = 0;
    ...
    public byte getByte(int i2) {
        l.b(this.directory[this.segments.length - 1], i2, 1L);
    ...
    void write(b bVar) {
        ...
        while (i2 < length) {
            ...
            int i4 = iArr[length + i2];
            int i5 = iArr[i2];
            h hVar = new h(this.segments[i2], i4, (i4 + i5) - i3, true, false);
            h hVar2 = bVar.a;
            if (hVar2 == null) {
                hVar.f8944g = hVar;
                hVar.f8943f = hVar;
    ...
    public boolean rangeEquals(int i2, byte[] bArr, int i3, int i4) {
        ...
        while (i4 > 0) {
            ...
            if (!l.a(bArr2[segment], (i2 - i5) + iArr[bArr2.length + segment], bArr, i3, min)) {
                return false;
            }
            i2 += min;
            i3 += min;
