...
public class VerticalViewPager extends ViewGroup {
    ...
    private f mAdapterChangeListener;
    ...
    public static class h implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return layoutParams.f8636e - layoutParams2.f8636e;
        }
    }
    ...
    private void calculatePageOffsets(d dVar, int i2, d dVar2) {
        ...
        if (dVar2 != null) {
            ...
            int i6 = dVar.b;
            if (i5 < i6) {
                float f3 = dVar2.f8639e + dVar2.f8638d + f2;
                int i7 = i5 + 1;
                int i8 = 0;
        ...
        float f5 = dVar.f8639e;
        int i9 = dVar.b;
        int i10 = i9 - 1;
        this.mFirstOffset = i9 == 0 ? f5 : -3.4028235E38f;
        int i11 = count - 1;
        this.mLastOffset = i9 == i11 ? (dVar.f8638d + f5) - 1.0f : Float.MAX_VALUE;
        int i12 = i2 - 1;
        while (i12 >= 0) {
        ...
        float f6 = dVar.f8639e + dVar.f8638d + f2;
        int i13 = dVar.b + 1;
        int i14 = i2 + 1;
        while (i14 < size2) {
            ...
            if (i3 == i11) {
                this.mLastOffset = (dVar8.f8638d + f6) - 1.0f;
            }
            dVar8.f8639e = f6;
            f6 += dVar8.f8638d + f2;
            i14++;
    ...
    private d infoForCurrentScrollPosition() {
        ...
        while (i4 < this.mItems.size()) {
            ...
            if (!z && dVar2.b != (i2 = i3 + 1)) {
                ...
                dVar2.f8639e = f2 + f4 + f3;
                dVar2.b = i2;
                dVar2.f8638d = this.mAdapter.getPageWidth(i2);
                i4--;
            }
            f2 = dVar2.f8639e;
            float f5 = dVar2.f8638d + f2 + f3;
            if (!z && scrollY < f2) {
                return dVar;
            }
    ...
    private boolean pageScrolled(int i2) {
        ...
        float f3 = ((i2 / f2) - infoForCurrentScrollPosition.f8639e) / (infoForCurrentScrollPosition.f8638d + (i3 / f2));
        this.mCalledSuper = false;
    ...
    private boolean performDrag(float f2) {
        ...
        if (dVar.b != 0) {
            f4 = dVar.f8639e * clientHeight;
            z = false;
        } else {
            z = true;
        }
        if (dVar2.b != this.mAdapter.getCount() - 1) {
            f5 = dVar2.f8639e * clientHeight;
            z2 = false;
        }
        if (scrollY < f4) {
    ...
    private void recomputeScrollPosition(int i2, int i3, int i4, int i5) {
        if (i3 > 0 && !this.mItems.isEmpty()) {
            ...
            this.mScroller.startScroll(0, scrollY, 0, (int) (infoForPosition(this.mCurItem).f8639e * i2), this.mScroller.getDuration() - this.mScroller.timePassed());
            return;
        }
        d infoForPosition = infoForPosition(this.mCurItem);
        int min = (int) ((infoForPosition != null ? Math.min(infoForPosition.f8639e, this.mLastOffset) : 0.0f) * ((i2 - getPaddingTop()) - getPaddingBottom()));
        if (min != getScrollY()) {
    ...
    private void scrollToItem(int i2, boolean z, int i3, boolean z2) {
        ...
        int clientHeight = infoForPosition != null ? (int) (getClientHeight() * Math.max(this.mFirstOffset, Math.min(infoForPosition.f8639e, this.mLastOffset))) : 0;
        if (z) {
    ...
    d addNewItem(int i2, int i3) {
        ...
        dVar.f8638d = this.mAdapter.getPageWidth(i2);
    ...
    */
    ...
    public void endFakeDrag() {
        if (this.mFakeDragging) {
            ...
            int scrollY = getScrollY();
            d infoForCurrentScrollPosition = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.b, ((scrollY / clientHeight) - infoForCurrentScrollPosition.f8639e) / infoForCurrentScrollPosition.f8638d, yVelocity, (int) (this.mLastMotionY - this.mInitialMotionY)), true, true, yVelocity);
            endDrag();
    ...
    public void fakeDragBy(float f2) {
        ...
        if (this.mFakeDragging) {
            ...
            d dVar = this.mItems.get(0);
            d dVar2 = this.mItems.get(arrayList.size() - 1);
            if (dVar.b != 0) {
                f3 = dVar.f8639e * clientHeight;
            }
            if (dVar2.b != this.mAdapter.getCount() - 1) {
                f4 = dVar2.f8639e * clientHeight;
            }
            if (scrollY < f3) {
                scrollY = f3;
            } else if (scrollY > f4) {
    ...
    protected int getChildDrawingOrder(int i2, int i3) {
        ...
        return ((LayoutParams) this.mDrawingOrderedChildren.get(i3).getLayoutParams()).f8637f;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f4 = this.mPageMargin / height2;
        int i3 = 0;
        d dVar = this.mItems.get(0);
        float f5 = dVar.f8639e;
        ...
        while (i4 < i5) {
            while (true) {
                ...
                i3++;
                dVar = this.mItems.get(i3);
            }
            if (i4 == i2) {
                float f6 = dVar.f8639e;
                float f7 = dVar.f8638d;
                f2 = (f6 + f7) * height2;
                f5 = f6 + f7 + f4;
            } else {
        ...
        if (action != 3 && action != 1) {
            ...
            if (action == 0) {
                ...
                if (i2 != -1) {
                    ...
                    if (i3 != 0 && !isGutterDrag(this.mLastMotionY, f2) && canScroll(this, false, (int) f2, (int) x2, (int) y2)) {
                    ...
                    if (abs > i4 && abs * 0.5f > abs2) {
                        ...
                        this.mLastMotionY = i3 > 0 ? f3 + f4 : f3 - f4;
                        this.mLastMotionX = x2;
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int scrollY = getScrollY();
            d infoForCurrentScrollPosition = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.b, ((scrollY / clientHeight) - infoForCurrentScrollPosition.f8639e) / infoForCurrentScrollPosition.f8638d, yVelocity, (int) (MotionEventCompat.getY(motionEvent, MotionEventCompat.findPointerIndex(motionEvent, this.mActivePointerId)) - this.mInitialMotionY)), true, true, yVelocity);
            this.mActivePointerId = -1;
            endDrag();
            onRelease = this.mTopEdge.onRelease();
            onRelease2 = this.mBottomEdge.onRelease();
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        ...
        if (pagerAdapter != null) {
            if (this.mObserver == null) {
                this.mObserver = new g(this, null);
            }
        ...
        f fVar = this.mAdapterChangeListener;
