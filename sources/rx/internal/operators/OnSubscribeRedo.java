...
public final class OnSubscribeRedo<T> implements Observable.OnSubscribe<T> {
        ...
        public Observable<?> call(Observable<? extends Notification<?>> observable) {
            return observable.map(new Func1<Notification<?>, Notification<?>>() { // from class: rx.internal.operators.OnSubscribeRedo.RedoFinite.1
                ...
                public Notification<?> call(Notification<?> notification) {
                    ...
                    int i2 = this.num + 1;
                    this.num = i2;
                    return ((long) i2) <= RedoFinite.this.count ? Notification.createOnNext(Integer.valueOf(this.num)) : notification;
                }
            }).dematerialize();
        }
    }
    ...
    public static <T> Observable<T> retry(Observable<T> observable, long j2) {
        ...
        if (i2 >= 0) {
            return i2 == 0 ? observable : retry(observable, new RedoFinite(j2));
        }
