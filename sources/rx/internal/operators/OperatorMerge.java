...
public final class OperatorMerge<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    public static final class MergeProducer<T> extends AtomicLong implements Producer {
        ...
        public void request(long j2) {
            ...
            } else if (get() == LocationRequestCompat.PASSIVE_INTERVAL) {
            } else {
    ...
    public static final class MergeSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        public MergeSubscriber(Subscriber<? super T> subscriber, boolean z, int i2) {
            ...
            request(i2 == Integer.MAX_VALUE ? LocationRequestCompat.PASSIVE_INTERVAL : i2);
        }
        ...
        void emitLoop() {
            ...
            try {
                ...
                while (!checkTerminate()) {
                    ...
                    boolean z3 = j3 == LocationRequestCompat.PASSIVE_INTERVAL;
                    if (queue != null) {
                        int i4 = 0;
                        while (true) {
                            j2 = j3;
                            ...
                            if (i5 > 0) {
                                j2 = z3 ? LocationRequestCompat.PASSIVE_INTERVAL : this.producer.produced(i5);
                            }
                            if (j2 == 0 || obj == null) {
                                break;
                            }
                    ...
                    if (length > 0) {
                        ...
                        if (length <= i6 || innerSubscriberArr[i6].id != j4) {
                            if (length <= i6) {
                                i6 = 0;
                            }
                            for (int i7 = 0; i7 < length && innerSubscriberArr[i6].id != j4; i7++) {
                                i6++;
                                if (i6 == length) {
                                    i6 = 0;
                                }
                        ...
                        for (int i8 = 0; i8 < length; i8++) {
                            ...
                            do {
                                ...
                                if (i9 > 0) {
                                    j2 = !z3 ? this.producer.produced(i9) : LocationRequestCompat.PASSIVE_INTERVAL;
