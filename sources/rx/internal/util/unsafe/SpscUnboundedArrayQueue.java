...
public class SpscUnboundedArrayQueue<E> extends SpscUnboundedArrayQueueConsumerField<E> implements QueueProgressIndicators {
    ...
    private static final long calcDirectOffset(long j2) {
        return REF_ARRAY_BASE + (j2 << REF_ELEMENT_SHIFT);
    }

    private static final long calcWrappedOffset(long j2, long j3) {
    ...
    private static final <E> Object lvElement(E[] eArr, long j2) {
    ...
    private static final void soElement(Object[] objArr, long j2, Object obj) {
