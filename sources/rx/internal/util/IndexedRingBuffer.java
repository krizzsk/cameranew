...
public final class IndexedRingBuffer<E> implements Subscription {
    ...
    public int add(E e2) {
        ...
        ((ElementSection) getElementSection(indexForAdd)).array.set(indexForAdd % i2, e2);
        return indexForAdd;
    }
    ...
    public void releaseToPool() {
        ...
        loop0: for (ElementSection<E> elementSection = this.elements; elementSection != null; elementSection = (ElementSection) ((ElementSection) elementSection).next.get()) {
            ...
            while (i4 < SIZE) {
                ...
                ((ElementSection) elementSection).array.set(i4, null);
                i4++;
                i3++;
            }
        }
    ...
    public E remove(int i2) {
        ...
        int i3 = SIZE;
        if (i2 < i3) {
            e2 = (E) ((ElementSection) this.elements).array.getAndSet(i2, null);
        } else {
            e2 = (E) ((ElementSection) getElementSection(i2)).array.getAndSet(i2 % i3, null);
        }
        pushRemovedIndex(i2);
        return e2;
    }
    ...
    private int forEach(Func1<? super E, Boolean> func1, int i2, int i3) {
        ...
        loop0: while (elementSection != null) {
            while (i2 < SIZE) {
                ...
                Object obj = (Object) ((ElementSection) elementSection).array.get(i2);
                if (obj != 0 && !func1.call(obj).booleanValue()) {
                    return i4;
                }
                i2++;
                i4++;
