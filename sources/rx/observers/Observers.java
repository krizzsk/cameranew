...
public final class Observers {
    ...
    public static final <T> Observer<T> create(final Action1<? super T> action1) {
        if (action1 != null) {
    ...
    public static final <T> Observer<T> create(final Action1<? super T> action1, final Action1<Throwable> action12) {
        if (action1 != null) {
            if (action12 != null) {
    ...
    public static final <T> Observer<T> create(final Action1<? super T> action1, final Action1<Throwable> action12, final Action0 action0) {
        if (action1 != null) {
            if (action12 != null) {
                if (action0 != null) {
