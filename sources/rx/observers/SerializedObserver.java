...
public class SerializedObserver<T> implements Observer<T> {
    ...
    */
    public void onNext(T r10) {
        ...
        L5:
            monitor-enter(r9)
            boolean r0 = r9.terminated     // Catch: java.lang.Throwable -> L83
            if (r0 == 0) goto Lc
            monitor-exit(r9)     // Catch: java.lang.Throwable -> L83
            return
        Lc:
            boolean r0 = r9.emitting     // Catch: java.lang.Throwable -> L83
            if (r0 == 0) goto L26
            rx.observers.SerializedObserver$FastList r0 = r9.queue     // Catch: java.lang.Throwable -> L83
            if (r0 != 0) goto L1b
            rx.observers.SerializedObserver$FastList r0 = new rx.observers.SerializedObserver$FastList     // Catch: java.lang.Throwable -> L83
            r0.<init>()     // Catch: java.lang.Throwable -> L83
            r9.queue = r0     // Catch: java.lang.Throwable -> L83
        L1b:
            rx.internal.operators.NotificationLite<T> r1 = r9.nl     // Catch: java.lang.Throwable -> L83
            java.lang.Object r10 = r1.next(r10)     // Catch: java.lang.Throwable -> L83
            r0.add(r10)     // Catch: java.lang.Throwable -> L83
            monitor-exit(r9)     // Catch: java.lang.Throwable -> L83
            return
        L26:
            r0 = 1
            r9.emitting = r0     // Catch: java.lang.Throwable -> L83
            monitor-exit(r9)     // Catch: java.lang.Throwable -> L83
