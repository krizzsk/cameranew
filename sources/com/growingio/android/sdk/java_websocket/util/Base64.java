        ...
        try {
            ...
            try {
                if (classLoader == 0) {
                    ...
                    objectInputStream = new ObjectInputStream(byteArrayInputStream) { // from class: com.growingio.android.sdk.java_websocket.util.Base64.1
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        return new String(r1.toByteArray(), PREFERRED_ENCODING);
