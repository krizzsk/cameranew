...
final class zzak {
    ...
    private static final BillingResult zzt = BillingResult.newBuilder().setResponseCode(4).setDebugMessage("Item is unavailable for purchase.").build();
    static final BillingResult zzm = BillingResult.newBuilder().setResponseCode(5).setDebugMessage("SKU can't be null.").build();
    private static final BillingResult zzu = BillingResult.newBuilder().setResponseCode(5).setDebugMessage("SKU type can't be null.").build();
    ...
    static final BillingResult zzs = BillingResult.newBuilder().setResponseCode(5).setDebugMessage("Unknown feature").build();
}
