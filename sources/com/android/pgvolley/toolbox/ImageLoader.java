...
public class ImageLoader {
    ...
    private void batchResponse(String str, BatchedImageRequest batchedImageRequest) {
        ...
        if (this.mRunnable == null) {
            Runnable runnable = new Runnable() { // from class: com.android.pgvolley.toolbox.ImageLoader.4
    ...
    public static ImageListener getImageListener(final ImageView imageView, final int i2, final int i3) {
        return new ImageListener() { // from class: com.android.pgvolley.toolbox.ImageLoader.1
    ...
    protected Request<Bitmap> makeImageRequest(String str, int i2, int i3, ImageView.ScaleType scaleType, final String str2) {
        return new ImageRequest(str, new Response.Listener<Bitmap>() { // from class: com.android.pgvolley.toolbox.ImageLoader.2
            @Override // com.android.pgvolley.Response.Listener
            public void onResponse(Bitmap bitmap) {
                ImageLoader.this.onGetImageSuccess(str2, bitmap);
            }
        }, i2, i3, scaleType, Bitmap.Config.RGB_565, new Response.ErrorListener() { // from class: com.android.pgvolley.toolbox.ImageLoader.3
            @Override // com.android.pgvolley.Response.ErrorListener
            public void onErrorResponse(VolleyError volleyError) {
