...
public enum Ld {
    ...
    Ld(int i2, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i2;
        this.A01 = nativeComponentTag;
    }

    public static Ld A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        Ld[] values;
        for (Ld ld : values()) {
            if (ld.A01 == nativeComponentTag) {
                return ld;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        Ld A00 = A00(nativeComponentTag);
        if (view != null && A00 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, Ld ld) {
        if (view != null && ld != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, ld);
        }
    }
