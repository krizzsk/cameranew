...
public class C0801Dp extends Exception {
    ...
    public C0801Dp(Format format, Throwable th, boolean z, int i2) {
    ...
    public C0801Dp(Format format, Throwable th, boolean z, String str) {
        super(A01(2, 21, 92) + str + A01(0, 2, 21) + format, th);
        this.A02 = format.A0O;
        this.A03 = z;
        this.A00 = str;
        this.A01 = C0923Il.A02 >= 21 ? A02(th) : null;
    }
