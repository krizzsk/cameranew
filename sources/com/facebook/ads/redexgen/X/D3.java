...
public final class D3 {
    ...
    public static Metadata.Entry A01(IV iv) {
        int typeTopByte = iv.A08() + iv.A06();
        int shortType = iv.A08();
        ...
        try {
                    ...
                    if (i3 != endPosition4) {
                        ...
                        if (i3 != endPosition5) {
                            ...
                            if (i3 != endPosition6) {
                                ...
                                if (i3 == endPosition7) {
                                    return A07(shortType, A09(1445, 4, 90), iv);
                                }
                                int endPosition8 = A03;
                                if (i3 == endPosition8) {
                                    return A07(shortType, A09(1457, 4, 37), iv);
                                }
                                int endPosition9 = A07;
                                if (i3 == endPosition9) {
                                    return A07(shortType, A09(1493, 4, 47), iv);
                                }
                                int endPosition10 = A02;
                                if (i3 == endPosition10) {
                                    return A07(shortType, A09(1425, 4, 51), iv);
                                }
                                int endPosition11 = A09;
                                if (i3 == endPosition11) {
                                    return A07(shortType, A09(1592, 4, 27), iv);
                                }
                                int endPosition12 = A08;
                                if (i3 == endPosition12) {
                                    return A07(shortType, A09(1441, 4, 121), iv);
                                }
                                int endPosition13 = A0J;
                                if (i3 == endPosition13) {
                                    return A07(shortType, A09(1449, 4, 57), iv);
                                }
                            }
                        }
                        return A07(shortType, A09(1437, 4, 105), iv);
                    }
                }
                TextInformationFrame A072 = A07(shortType, A09(1453, 4, 67), iv);
                iv.A0Y(typeTopByte);
                if (A01[3].charAt(3) != 'b') {
                    String[] strArr = A01;
            ...
            if (shortType == endPosition14) {
                TextInformationFrame A082 = A08(iv);
                iv.A0Y(typeTopByte);
                String[] strArr2 = A01;
            ...
            if (shortType == endPosition16) {
                return A06(shortType, A09(1465, 4, 120), iv);
            }
            int endPosition17 = A0S;
            if (shortType == endPosition17) {
                return A06(shortType, A09(1469, 4, 7), iv);
            }
            int endPosition18 = A0R;
            if (shortType == endPosition18) {
                return A04(shortType, A09(1429, 4, 15), iv, true, false);
            }
            int endPosition19 = A0E;
            if (shortType == endPosition19) {
                return A04(shortType, A09(1433, 4, 84), iv, true, true);
            }
            ...
            if (shortType == endPosition21) {
                return A07(shortType, A09(1461, 4, 56), iv);
            }
            int endPosition22 = A0Q;
            if (shortType == endPosition22) {
                return A07(shortType, A09(1489, 4, 17), iv);
            }
            int endPosition23 = A0M;
            if (shortType == endPosition23) {
                return A07(shortType, A09(1473, 4, 6), iv);
            }
            int endPosition24 = A0O;
            if (shortType == endPosition24) {
                return A07(shortType, A09(1477, 4, 14), iv);
            }
            int endPosition25 = A0N;
            if (shortType == endPosition25) {
                return A07(shortType, A09(1485, 4, 121), iv);
            }
            int endPosition26 = A0P;
            if (shortType == endPosition26) {
                return A07(shortType, A09(1481, 4, 102), iv);
            }
            int endPosition27 = A0L;
            if (shortType == endPosition27) {
                return A04(shortType, A09(843, 14, 87), iv, false, false);
            }
            int endPosition28 = A0H;
            if (shortType == endPosition28) {
                return A04(shortType, A09(857, 13, 92), iv, false, true);
            }
            int endPosition29 = A0U;
            if (shortType == endPosition29) {
                return A07(shortType, A09(1503, 10, 78), iv);
            }
            int endPosition30 = A0T;
            if (shortType == endPosition30) {
                return A07(shortType, A09(1497, 6, 69), iv);
            }
            int endPosition31 = A0K;
            if (shortType == endPosition31) {
                return A05(iv, typeTopByte);
            }
            String str3 = A09(1287, 32, 3) + AbstractC0776Cq.A02(shortType);
            return null;
        } finally {
            iv.A0Y(typeTopByte);
        }
    ...
    public static ApicFrame A02(IV iv) {
        String A092;
        int atomType = iv.A08();
        int A082 = iv.A08();
        int i2 = AbstractC0776Cq.A0F;
        ...
        int fullVersionInt = AbstractC0776Cq.A00(iv.A08());
    ...
    public static CommentFrame A03(int atomSize, IV iv) {
        int A082 = iv.A08();
        if (iv.A08() == AbstractC0776Cq.A0F) {
            iv.A0Z(8);
            String A0R2 = iv.A0R(A082 - 16);
            return new CommentFrame(A09(1744, 3, 3), A0R2, A0R2);
        }
        Log.w(A09(981, 12, 3), A09(457, 35, 20) + AbstractC0776Cq.A02(atomSize));
        return null;
    }

    public static Id3Frame A04(int value, String str, IV iv, boolean z, boolean z2) {
        int A002 = A00(iv);
        if (z2) {
            String[] strArr = A01;
            if (strArr[1].charAt(22) == strArr[7].charAt(22)) {
        ...
        Log.w(A09(981, 12, 3), A09(670, 33, 84) + AbstractC0776Cq.A02(value));
        return null;
    }

    public static Id3Frame A05(IV iv, int i2) {
        String str = null;
        String str2 = null;
        int atomPosition = -1;
        int atomSize = -1;
        while (iv.A06() < i2) {
            ...
            int A083 = iv.A08();
            iv.A0Z(4);
            int atomType = AbstractC0776Cq.A0e;
            if (A083 == atomType) {
                int atomType2 = A082 - 12;
                str = iv.A0R(atomType2);
            } else {
                int atomType3 = AbstractC0776Cq.A0o;
                if (A083 == atomType3) {
                    int atomType4 = A082 - 12;
                    str2 = iv.A0R(atomType4);
                } else {
                    int atomType5 = AbstractC0776Cq.A0F;
                    if (A083 == atomType5) {
                        atomPosition = A062;
                        atomSize = A082;
                    }
        ...
        return new InternalFrame(str, str2, iv.A0R(atomType7));
    }

    public static TextInformationFrame A06(int atomSize, String str, IV iv) {
        int A082 = iv.A08();
        if (iv.A08() == AbstractC0776Cq.A0F && A082 >= 22) {
            iv.A0Z(10);
            int A0I2 = iv.A0I();
            if (A0I2 > 0) {
        ...
        Log.w(A09(981, 12, 3), A09(527, 39, 49) + AbstractC0776Cq.A02(atomSize));
        return null;
    }

    public static TextInformationFrame A07(int atomSize, String str, IV iv) {
        int A082 = iv.A08();
        if (iv.A08() == AbstractC0776Cq.A0F) {
            iv.A0Z(8);
            return new TextInformationFrame(str, null, iv.A0R(A082 - 16));
        }
        Log.w(A09(981, 12, 3), A09(601, 32, 115) + AbstractC0776Cq.A02(atomSize));
        return null;
    }
    ...
    */
    public static com.facebook.ads.internal.exoplayer2.metadata.id3.TextInformationFrame A08(com.facebook.ads.redexgen.X.IV r4) {
        /*
            int r2 = A00(r4)
            r4 = 0
            if (r2 <= 0) goto L21
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.D3.A0V
            int r0 = r1.length
            if (r2 > r0) goto L21
            int r0 = r2 + (-1)
            r3 = r1[r0]
        ...
        L23:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.D3.A08(com.facebook.ads.redexgen.X.IV):com.facebook.ads.internal.exoplayer2.metadata.id3.TextInformationFrame");
    }
}
