...
public final class IG implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new IE(C0923Il.A0P(A04(0, 67, 11), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static EGLContext A01(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i2) {
        ...
        throw new IE(A04(67, 23, 49));
    }

    public static EGLDisplay A02() {
        EGLDisplay display = EGL14.eglGetDisplay(0);
        if (display == null) {
            throw new IE(A04(120, 20, 23));
        }
        int[] iArr = new int[2];
        if (!EGL14.eglInitialize(display, iArr, 0, iArr, 1)) {
            throw new IE(A04(InspirePublishFragment.MAX_DESC_COUNT, 20, 105));
        }
        return display;
    }
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i2) {
        ...
        if (i2 == 1) {
            ...
            if (eglCreatePbufferSurface == null) {
                throw new IE(A04(90, 30, 124));
            }
        }
        if (!EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext)) {
            throw new IE(A04(160, 21, 115));
        }
    ...
    public static void A06(int[] iArr) {
        ...
        throw new IE(A04(181, 29, 47) + Integer.toHexString(errorCode));
    }

    public final SurfaceTexture A07() {
        return (SurfaceTexture) I6.A01(this.A00);
    }
