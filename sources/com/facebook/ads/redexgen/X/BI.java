...
public final class BI extends Exception {
    ...
    */
    public BI(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.BI.<init>(int, int, int, int):void");
    }
}
