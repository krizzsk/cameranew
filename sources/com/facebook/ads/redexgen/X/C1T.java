...
public final class C1T {
    ...
    public static C1P A00(JSONObject jSONObject) {
        return new C1O().A06(A06(jSONObject)).A07(A05(jSONObject)).A05(A07(jSONObject)).A04(A04(jSONObject)).A08();
    }

    public static C1Z A01(JSONObject jSONObject) {
        return new C1Y().A02(A08(jSONObject)).A03(A09(jSONObject)).A04();
    }
    ...
    public static String A03(JSONObject jSONObject) {
        ...
        return genericTextObject == null ? A02 : genericTextObject.optString(A02(IjkMediaMeta.FF_PROFILE_H264_HIGH_444_PREDICTIVE, 9, 30), A02);
    }
