...
public class d {
    private static final String a = "com.facebook.appevents.codeless.internal.d";
    ...
    public static int c(View view) {
        ...
        try {
            ...
            if (!(view instanceof Spinner) && !(view instanceof DatePicker)) {
                return view instanceof RatingBar ? i2 | 65536 : view instanceof RadioGroup ? i2 | 16384 : ((view instanceof ViewGroup) && p(view, b.get())) ? i2 | 64 : i2;
            }
            return i2 | 4096;
        } catch (Throwable th) {
            com.facebook.internal.instrument.e.a.b(th, d.class);
    ...
    private static JSONObject e(View view) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put(TJAdUnitConstants.String.TOP, view.getTop());
                jSONObject.put(TJAdUnitConstants.String.LEFT, view.getLeft());
    ...
    public static ViewGroup j(View view) {
        if (com.facebook.internal.instrument.e.a.c(d.class) || view == null) {
            return null;
        }
        try {
            ViewParent parent = view.getParent();
    ...
    */
    public static java.lang.String k(android.view.View r9) {
        /*
            java.lang.Class<com.facebook.appevents.codeless.internal.d> r0 = com.facebook.appevents.codeless.internal.d.class
            boolean r1 = com.facebook.internal.instrument.e.a.c(r0)
            r2 = 0
            if (r1 == 0) goto La
            return r2
        La:
        ...
        Le2:
            r9 = move-exception
            com.facebook.internal.instrument.e.a.b(r9, r0)
            return r2
        */
    ...
    @Nullable
    public static View l(float[] fArr, @Nullable View view) {
        if (com.facebook.internal.instrument.e.a.c(d.class)) {
            return null;
        }
        try {
    ...
    public static boolean p(View view, @Nullable View view2) {
        View l2;
        if (com.facebook.internal.instrument.e.a.c(d.class)) {
            return false;
        }
        try {
            if (!view.getClass().getName().equals("com.facebook.react.views.view.ReactViewGroup") || (l2 = l(m(view), view2)) == null) {
                return false;
            }
            return l2.getId() == view.getId();
        } catch (Throwable th) {
            com.facebook.internal.instrument.e.a.b(th, d.class);
            return false;
        }
    ...
    public static void s(View view, JSONObject jSONObject) {
        try {
            ...
            try {
                ...
                jSONObject.put(TapjoyAuctionFlags.AUCTION_ID, view.getId());
                if (!b.g(view)) {
                    jSONObject.put("text", x.i(x.v0(k2), ""));
                } else {
                    jSONObject.put("text", "");
                    jSONObject.put("is_user_input", true);
                }
                jSONObject.put(TrackReferenceTypeBox.TYPE1, x.i(x.v0(i2), ""));
                if (tag != null) {
                    jSONObject.put(Issue.ISSUE_REPORT_TAG, x.i(x.v0(tag.toString()), ""));
                }
                if (contentDescription != null) {
                    jSONObject.put(SocialConstants.PARAM_COMMENT, x.i(x.v0(contentDescription.toString()), ""));
                }
                jSONObject.put(TypedValues.Custom.S_DIMENSION, e(view));
            } catch (JSONException e2) {
                x.X(a, e2);
            }
        } catch (Throwable th) {
