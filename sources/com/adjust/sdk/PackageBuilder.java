...
public class PackageBuilder {
    ...
    private Map<String, String> getAdRevenueParameters(String str, JSONObject jSONObject) {
        ...
        if (!containsPlayIds(hashMap)) {
            ...
            addString(hashMap, TapjoyConstants.TJC_ANDROID_ID, this.deviceInfo.androidId);
        }
        ...
        addString(hashMap, BigAlbumStore.PhotoAddressColumns.COUNTRY, this.deviceInfo.country);
        ...
        addString(hashMap, JsonMarshaller.ENVIRONMENT, this.adjustConfig.environment);
        ...
        addString(hashMap, IjkMediaMeta.IJKM_KEY_LANGUAGE, this.deviceInfo.language);
