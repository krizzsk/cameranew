...
public class DeviceInfo {
    ...
    private String getFacebookAttributionId(Context context) {
        ...
        try {
            ...
            if (signatureArr == null || signatureArr.length != 1 || !OFFICIAL_FACEBOOK_SIGNATURE.equals(signatureArr[0].toCharsString()) || (query = context.getContentResolver().query(Uri.parse("content://com.facebook.katana.provider.AttributionIdProvider"), new String[]{com.tencent.stat.DeviceInfo.TAG_ANDROID_ID}, null, null, null)) == null) {
                return null;
            }
            ...
            String string = query.getString(query.getColumnIndex(com.tencent.stat.DeviceInfo.TAG_ANDROID_ID));
            query.close();
            return string;
        } catch (Exception unused) {
        }
    ...
    public void reloadPlayIds(Context context) {
        ...
        for (int i2 = 1; i2 <= 3; i2++) {
            try {
                GooglePlayServicesClient.GooglePlayServicesInfo googlePlayServicesInfo = GooglePlayServicesClient.getGooglePlayServicesInfo(context, i2 * PathInterpolatorCompat.MAX_NUM_POINTS);
