...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public abstract class f<T> implements Iterator<T> {
        ...
        f() {
            this.a = LinkedHashTreeMap.this.header.f458d;
    ...
    private void rebalance(g<K, V> gVar, boolean z) {
        while (gVar != null) {
            g<K, V> gVar2 = gVar.b;
            g<K, V> gVar3 = gVar.c;
            int i2 = gVar2 != null ? gVar2.f463i : 0;
            int i3 = gVar3 != null ? gVar3.f463i : 0;
            int i4 = i2 - i3;
            if (i4 == -2) {
                g<K, V> gVar4 = gVar3.b;
                g<K, V> gVar5 = gVar3.c;
                int i5 = (gVar4 != null ? gVar4.f463i : 0) - (gVar5 != null ? gVar5.f463i : 0);
                if (i5 != -1 && (i5 != 0 || z)) {
                    rotateRight(gVar3);
                    rotateLeft(gVar);
                } else {
                ...
                g<K, V> gVar6 = gVar2.b;
                g<K, V> gVar7 = gVar2.c;
                int i6 = (gVar6 != null ? gVar6.f463i : 0) - (gVar7 != null ? gVar7.f463i : 0);
                if (i6 != 1 && (i6 != 0 || z)) {
                    rotateLeft(gVar2);
                    rotateRight(gVar);
                } else {
    ...
    private void rotateLeft(g<K, V> gVar) {
        ...
        gVar3.b = gVar;
        gVar.a = gVar3;
        int max = Math.max(gVar2 != null ? gVar2.f463i : 0, gVar4 != null ? gVar4.f463i : 0) + 1;
        gVar.f463i = max;
        gVar3.f463i = Math.max(max, gVar5 != null ? gVar5.f463i : 0) + 1;
    }
    ...
    private void rotateRight(g<K, V> gVar) {
        ...
        gVar2.c = gVar;
        gVar.a = gVar2;
        int max = Math.max(gVar3 != null ? gVar3.f463i : 0, gVar5 != null ? gVar5.f463i : 0) + 1;
        gVar.f463i = max;
        gVar2.f463i = Math.max(max, gVar4 != null ? gVar4.f463i : 0) + 1;
    }
    ...
    public void clear() {
        ...
        g<K, V> gVar2 = gVar.f458d;
        while (gVar2 != gVar) {
            g<K, V> gVar3 = gVar2.f458d;
            gVar2.f459e = null;
            gVar2.f458d = null;
            gVar2 = gVar3;
        }
    ...
    g<K, V> find(K k2, boolean z) {
        ...
        if (gVar3 != null) {
            ...
            while (true) {
                if (comparable != null) {
                    compare = comparable.compareTo(gVar3.f460f);
                } else {
                    compare = comparator.compare(k2, (K) gVar3.f460f);
                }
                if (compare == 0) {
                    return gVar3;
                }
        ...
        if (z) {
            ...
            if (gVar == null) {
                ...
                gVar2 = new g<>(gVar, k2, secondaryHash, gVar5, gVar5.f459e);
    ...
    g<K, V> findByEntry(Map.Entry<?, ?> entry) {
        ...
        if (findByObject != null && equal(findByObject.f462h, entry.getValue())) {
            return findByObject;
        }
        return null;
    }
    ...
    public V remove(Object obj) {
        ...
        if (removeInternalByKey != null) {
            return removeInternalByKey.f462h;
        }
        return null;
    }
    ...
    void removeInternal(g<K, V> gVar, boolean z) {
        int i2;
        if (z) {
            g<K, V> gVar2 = gVar.f459e;
            gVar2.f458d = gVar.f458d;
            gVar.f458d.f459e = gVar2;
            gVar.f459e = null;
            gVar.f458d = null;
        }
        g<K, V> gVar3 = gVar.b;
        ...
        if (gVar3 != null && gVar4 != null) {
            g<K, V> b2 = gVar3.f463i > gVar4.f463i ? gVar3.b() : gVar4.a();
