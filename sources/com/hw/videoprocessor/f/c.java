...
public class c {
    private void A(int i2, int[] iArr, double[] dArr) {
        int i3 = 0;
        iArr[0] = i2;
        iArr[1] = 1;
        if (i2 > 2) {
    ...
    private final void a(int i2, int[] iArr, int i3, double[] dArr) {
        int i4;
        iArr[i3 + 0] = 0;
        int i5 = i2;
        int i6 = 1;
    ...
    private final void f(int i2, int[] iArr, int i3, double[] dArr) {
        int i4;
        iArr[i3 + 0] = 0;
        int i5 = i2;
        int i6 = 1;
    ...
    private final void h(int i2, double[] dArr, double[] dArr2, int i3) {
        int i4 = i2 >> 3;
        int i5 = i4 * 2;
        int i6 = i5 + i5;
        int i7 = i6 + i5;
    ...
    private void i(int i2, double[] dArr, int[] iArr, int i3, int i4, double[] dArr2) {
        if (i2 > 32) {
            int i5 = i2 >> 2;
    ...
    private void j(int i2, double[] dArr, int i3, int i4, double[] dArr2) {
        int i5 = i2 >> 2;
        while (i5 > 128) {
    ...
    private void k(int i2, double[] dArr, int i3, int i4, double[] dArr2) {
        int i5 = i2 >> 1;
        int i6 = i2 >> 2;
        while (i6 > 128) {
    ...
    private void m(double[] dArr, int i2, double[] dArr2, int i3) {
    ...
    private void n(double[] dArr, int i2, double[] dArr2, int i3) {
        double d2 = dArr2[i3 + 1];
    ...
    private void o(double[] dArr, int i2, double[] dArr2, int i3) {
        double d2 = dArr2[i3 + 1];
        int i4 = i3 + 2;
    ...
    private void p(double[] dArr, int i2, double[] dArr2, int i3) {
        double d2 = dArr2[i3 + 1];
        double d3 = dArr2[i3 + 4];
        double d4 = dArr2[i3 + 5];
    ...
    private void q(int i2, double[] dArr, double[] dArr2, int i3) {
        int i4 = i2 >> 3;
        int i5 = i4 * 2;
        int i6 = i5 + i5;
        int i7 = i6 + i5;
    ...
    private void r(int i2, double[] dArr, int[] iArr, int i3, int i4, double[] dArr2) {
        if (i2 > 32) {
            int i5 = i2 >> 2;
    ...
    private void s(int i2, double[] dArr, int i3, int i4, double[] dArr2) {
        if (i2 == 128) {
            int i5 = i4 - 8;
            o(dArr, i3, dArr2, i5);
    ...
    private void t(int i2, double[] dArr, int i3, int i4, double[] dArr2) {
        if (i2 == 128) {
            int i5 = i4 - 8;
            o(dArr, i3, dArr2, i5);
            int i6 = i4 - 32;
    ...
    private final void u(int i2, double[] dArr, int i3, double[] dArr2, int i4) {
        int i5 = i2 >> 3;
        int i6 = i5 * 2;
        int i7 = i6 + i6;
        int i8 = i7 + i6;
    ...
    private final void v(int i2, double[] dArr, int i3, double[] dArr2, int i4) {
        int i5 = i2 >> 3;
        int i6 = i5 * 2;
    ...
    private void w(int i2, double[] dArr, int i3, int i4, double[] dArr2) {
        int i5 = i2 >> 2;
        int i6 = i5 * 2;
    ...
    private void x(int i2, double[] dArr, int i3, int i4, double[] dArr2) {
        int i5 = i2 >> 2;
    ...
    private void z(int i2, int[] iArr, double[] dArr, int i3) {
        iArr[1] = i2;
        if (i2 > 1) {
            int i4 = i2 >> 1;
            double d2 = i4;
