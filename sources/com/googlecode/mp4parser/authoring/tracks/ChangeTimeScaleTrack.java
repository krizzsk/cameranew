...
public class ChangeTimeScaleTrack implements Track {
    ...
    static List<CompositionTimeToSample.Entry> adjustCtts(List<CompositionTimeToSample.Entry> list, double d2) {
        if (list != null) {
    ...
    static long[] adjustTts(long[] jArr, double d2, long[] jArr2, long[] jArr3) {
