            ...
            if (this.indexToKey.get(Integer.valueOf(i10)) != null) {
                ...
                if (this.subSampleEncryption) {
                    if (z2) {
                        ...
                        pairArr[c] = cencSampleAuxiliaryDataFormat.createPair(byteBuffer.remaining(), 0L);
                        ...
                        while (byteBuffer.remaining() > 0) {
                            ...
                            int i11 = l2i + i4;
                            arrayList2.add(cencSampleAuxiliaryDataFormat.createPair(i11 >= 112 ? (i11 % 16) + 96 : i11, i11 - i2));
