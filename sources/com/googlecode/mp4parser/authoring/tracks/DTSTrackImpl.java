...
public class DTSTrackImpl extends AbstractTrack {
    ...
    public class a implements Sample {
        ...
        a(DTSTrackImpl dTSTrackImpl, ByteBuffer byteBuffer) {
            this.a = byteBuffer;
        }
    ...
    public class b {
        ...
        b(DTSTrackImpl dTSTrackImpl, DataSource dataSource, long j2, long j3, int i2) throws IOException {
            this.f5071d = dataSource;
            this.b = j2;
            this.f5072e = j3 + j2;
            this.a = i2;
            d();
        ...
        private void d() throws IOException {
            ...
            DataSource dataSource = this.f5071d;
            long j2 = this.b;
            this.f5073f = dataSource.map(j2, Math.min(this.f5072e - j2, 67108864L));
        }
        ...
        private ByteBuffer f() {
            ...
            long j3 = this.b;
            if (j2 >= j3) {
                this.f5073f.position((int) (j2 - j3));
                ByteBuffer slice = this.f5073f.slice();
                slice.limit((int) (this.c - (this.f5074g - this.b)));
                return slice;
            }
            throw new RuntimeException("damn! NAL exceeds buffer");
        }

        private boolean g(byte b, byte b2, byte b3, byte b4) throws IOException {
            int limit = this.f5073f.limit();
            int i2 = this.c;
            if (limit - i2 >= 4) {
                return this.f5073f.get(i2) == b && this.f5073f.get(this.c + 1) == b2 && this.f5073f.get(this.c + 2) == b3 && this.f5073f.get(this.c + 3) == b4;
            } else if (this.b + i2 + 4 < this.f5071d.size()) {
                return false;
            } else {
        ...
        private boolean l(byte b, byte b2, byte b3, byte b4) throws IOException {
            int limit = this.f5073f.limit();
            int i2 = this.c;
            if (limit - i2 >= 4) {
                if ((this.b + i2) % PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED == 0) {
                    PrintStream printStream = System.err;
                    StringBuilder sb = new StringBuilder();
                    sb.append(((this.b + this.c) / 1024) / 1024);
                    printStream.println(sb.toString());
                }
                return this.f5073f.get(this.c) == b && this.f5073f.get(this.c + 1) == b2 && this.f5073f.get(this.c + 2) == b3 && this.f5073f.get(this.c + 3) == b4;
            }
            long j2 = this.b;
            long j3 = this.f5072e;
            if (i2 + j2 + 4 > j3) {
    ...
    public DTSTrackImpl(DataSource dataSource, String str) throws IOException {
        ...
        this.type = PortalFollowFeeds.TYPE_NONE;
        this.lang = "eng";
        this.lang = str;
    ...
    private List<Sample> generateSamples(DataSource dataSource, int i2, long j2, int i3) throws IOException {
        b bVar = new b(this, dataSource, i2, j2, i3);
    ...
    private int getBitRate(int i2) throws IOException {
        switch (i2) {
            ...
            case 13:
                return 576;
            case 14:
                return VideoEdit2Activity.MIN_SCALED_SIZE;
            case 15:
                return 768;
            case 16:
                return 960;
    ...
    private int getSampleRate(int i2) throws IOException {
        switch (i2) {
            case 1:
                return PayResult.PAY_RESULT_ALIPAY_CHECK_IN;
            case 2:
                return 16000;
            case 3:
                return 32000;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:202:0x0297, code lost:
        if (((r26.channelMask >> r7) & 1) != 1) goto L186;
     */
