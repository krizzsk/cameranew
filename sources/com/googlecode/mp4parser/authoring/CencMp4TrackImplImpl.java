...
public class CencMp4TrackImplImpl extends Mp4TrackImpl implements CencEncryptedTrack {
    ...
    private class a {
        ...
        public a e() {
            ...
            for (int i2 = 0; i2 < boxes.size(); i2++) {
                ...
                if ((this.c == null && ((SampleAuxiliaryInformationOffsetsBox) boxes2.get(i2)).getAuxInfoType() == null) || "cenc".equals(((SampleAuxiliaryInformationOffsetsBox) boxes2.get(i2)).getAuxInfoType())) {
                    this.c = (SampleAuxiliaryInformationOffsetsBox) boxes2.get(i2);
                } else {
    ...
    public CencMp4TrackImplImpl(String str, TrackBox trackBox, IsoFile... isoFileArr) throws IOException {
            ...
            while (it.hasNext()) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (trackFragmentBox.getTrackFragmentHeaderBox().getTrackId() == trackId) {
                        ...
                        SampleAuxiliaryInformationSizesBox d2 = aVar.d();
                        ...
                        while (i4 < offsets.length) {
                            ...
                            int i7 = i5;
                            while (i7 < i3) {
                                this.sampleEncryptionEntries.add(parseCencAuxDataFormat(trackEncryptionBox.getDefaultIvSize(), byteBuffer, d2.getSize(i7)));
                                i7++;
                                i3 = i3;
                                movieFragmentBox = movieFragmentBox;
                                it2 = it2;
        ...
        a aVar2 = new a(this, (Container) Path.getPath((AbstractContainerBox) trackBox, "mdia[0]/minf[0]/stbl[0]"));
        aVar2.e();
