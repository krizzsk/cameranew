...
public final class b {
    ...
    private static p f7796d;

    /* renamed from: e  reason: collision with root package name */
    private static boolean f7797e;
        ...
        synchronized (b.class) {
            if (f7797e) {
                ...
                if (f2 == null) {
                    ...
                    a(context, f2, a2.v, buglyStrategy);
                }
            }
        }
    }
    ...
    public static synchronized void a(Context context, String str, boolean z, BuglyStrategy buglyStrategy) {
        ...
        synchronized (b.class) {
            if (f7797e) {
                ...
                x.a("[init] Bugly complete version: v%s", "3.3.9");
                ...
                if (buglyStrategy != null) {
                    ...
                    try {
                        if (buglyStrategy.isReplaceOldChannel()) {
                            ...
                            if (!TextUtils.isEmpty(appChannel)) {
                                ...
                                f7796d.a(556, "app_channel", appChannel.getBytes(), (o) null, false);
                                a3.m = appChannel;
                            }
                        } else {
                            Map<String, byte[]> a6 = f7796d.a(556, (o) null, true);
                    ...
                    a3.f7818e = buglyStrategy.isUploadProcess();
