    ...
    private static CrashDetailBean a(Context context, Map<String, String> map, NativeExceptionHandler nativeExceptionHandler) {
        ...
        if (str3 != null && str3.trim().length() > 0) {
            ...
            try {
                ...
                map.get("errnoMsg");
                String str12 = map.get(SharePluginInfo.ISSUE_TRACE_STACK);
                if (str12 == null) {
                    str12 = "unknown";
                }
                ...
                if (packageCrashDatas != null) {
                    String str22 = map.get(GuestProfileFragment.USER_ID);
                    if (str22 != null) {
                    ...
                    String str24 = map.get(RemoteConfigConstants.RequestFieldKey.APP_VERSION);
                    if (str24 != null) {
                        x.c("[Native record info] appVersion: %s", str24);
                        packageCrashDatas.f7844f = str24;
                    }
