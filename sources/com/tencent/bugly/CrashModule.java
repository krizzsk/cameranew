...
public class CrashModule extends a {
    ...
    private static CrashModule f7788e = new CrashModule();
    private long a;
    ...
    public static CrashModule getInstance() {
        CrashModule crashModule = f7788e;
        crashModule.id = 1004;
        return crashModule;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x0085 A[Catch: all -> 0x00af, TryCatch #0 {, blocks: (B:4:0x0003, B:7:0x0009, B:9:0x0039, B:11:0x0049, B:13:0x004f, B:14:0x0052, B:16:0x0057, B:19:0x005e, B:22:0x006e, B:25:0x0075, B:28:0x0085, B:30:0x008c, B:26:0x0080, B:20:0x0069), top: B:38:0x0003 }] */
    ...
    */
    public synchronized void init(android.content.Context r12, boolean r13, com.tencent.bugly.BuglyStrategy r14) {
        /*
            ...
            monitor-enter(r11)
            if (r12 == 0) goto Lb2
            boolean r0 = r11.f7789d     // Catch: java.lang.Throwable -> Laf
            if (r0 == 0) goto L9
            goto Lb2
        L9:
            ...
            r11.f7789d = r3     // Catch: java.lang.Throwable -> Laf
