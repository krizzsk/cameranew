...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private String finderShareVideoJumpInfoToString(IWXChannelJumpInfo iWXChannelJumpInfo) {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                jSONObject.put(JsonMarshaller.EXTRA, ((WXChannelBaseJumpInfo) iWXChannelJumpInfo).extra);
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    ...
                    str2 = PGEditResultActivity2.PATH;
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (b.b(queryParameter)) {
            ...
            resp.scene = b.a(parse.getQueryParameter(SharePluginInfo.ISSUE_SCENE), 0);
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            VdsAgent.onPendingIntentGetActivityShortBefore(context, 1, launchIntentForPackage, 134217728);
            PendingIntent activity = PendingIntent.getActivity(context, 1, launchIntentForPackage, 134217728);
            VdsAgent.onPendingIntentGetActivityShortAfter(context, 1, launchIntentForPackage, 134217728, activity);
            activity.send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
    ...
    public int getWXAppSupportAPI() {
        ...
        b.f8141e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
    ...
    public boolean registerApp(String str, long j2) {
        ...
        c0276a.a = "com.tencent.mm";
        c0276a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0276a.c = "weixin://registerapp?appid=" + this.appId;
        c0276a.f8125d = j2;
        return a.a(this.context, c0276a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0276a c0276a = new a.C0276a();
        c0276a.a = "com.tencent.mm";
        c0276a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0276a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0276a);
    }
}
