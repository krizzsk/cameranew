...
class i extends h {
    ...
    public i(int i2, byte[] bArr) {
        this.a = bArr;
        this.f8288e = (i2 & 8) == 0 ? f8285f : f8286g;
        this.c = 0;
        this.f8287d = 0;
    }
