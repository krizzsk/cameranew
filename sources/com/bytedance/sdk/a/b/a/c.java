...
public final class c {
    ...
    public static final z f909d;
    public static final String[] b = new String[0];

    /* renamed from: i  reason: collision with root package name */
    private static final f f914i = f.b("efbbbf");

    /* renamed from: j  reason: collision with root package name */
    private static final f f915j = f.b("feff");

    /* renamed from: k  reason: collision with root package name */
    private static final f f916k = f.b("fffe");

    /* renamed from: l  reason: collision with root package name */
    private static final f f917l = f.b("0000ffff");
    private static final f m = f.b("ffff0000");

    /* renamed from: e  reason: collision with root package name */
    public static final Charset f910e = Charset.forName("UTF-8");

    /* renamed from: f  reason: collision with root package name */
    public static final Charset f911f = Charset.forName("ISO-8859-1");
    ...
    public static final TimeZone f912g = TimeZone.getTimeZone("GMT");

    /* renamed from: h  reason: collision with root package name */
    public static final Comparator<String> f913h = new Comparator<String>() { // from class: com.bytedance.sdk.a.b.a.c.1
    ...
    public static boolean b(s sVar, int i2, TimeUnit timeUnit) throws IOException {
        ...
        try {
            ...
            if (c_ == LocationRequestCompat.PASSIVE_INTERVAL) {
                sVar.a().f();
            } else {
    ...
    private static String a(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i3) {
                ...
                cVar.k(((bArr[i2] & Draft_75.END_OF_FRAME) << 8) | (bArr[i2 + 1] & Draft_75.END_OF_FRAME));
                i2 += 2;
            }
        }
        return cVar.o();
