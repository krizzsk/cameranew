...
final class b {
    ...
    private static String a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i3 = 0; i3 < length; i3 += 3) {
            int i4 = i2 + 1;
            bArr3[i2] = bArr2[(bArr[i3] & Draft_75.END_OF_FRAME) >> 2];
            int i5 = i4 + 1;
            int i6 = i3 + 1;
            bArr3[i4] = bArr2[((bArr[i3] & 3) << 4) | ((bArr[i6] & Draft_75.END_OF_FRAME) >> 4)];
            int i7 = i5 + 1;
            int i8 = i3 + 2;
            bArr3[i5] = bArr2[((bArr[i6] & 15) << 2) | ((bArr[i8] & Draft_75.END_OF_FRAME) >> 6)];
            i2 = i7 + 1;
        ...
        if (length2 == 1) {
            int i9 = i2 + 1;
            bArr3[i2] = bArr2[(bArr[length] & Draft_75.END_OF_FRAME) >> 2];
            int i10 = i9 + 1;
            ...
            int i12 = i11 + 1;
            int i13 = length + 1;
            bArr3[i11] = bArr2[((bArr[i13] & Draft_75.END_OF_FRAME) >> 4) | ((bArr[length] & 3) << 4)];
