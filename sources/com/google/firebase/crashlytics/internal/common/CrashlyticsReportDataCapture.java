...
public class CrashlyticsReportDataCapture {
    ...
    static {
        ...
        GENERATOR = String.format(Locale.US, "Crashlytics Android SDK/%s", "17.4.0");
    }
    ...
    private CrashlyticsReport.Builder buildReportData() {
        return CrashlyticsReport.builder().setSdkVersion("17.4.0").setGmpAppId(this.appData.googleAppId).setInstallationUuid(this.idManager.getCrashlyticsInstallId()).setBuildVersion(this.appData.versionCode).setDisplayVersion(this.appData.versionName).setPlatform(4);
    }
