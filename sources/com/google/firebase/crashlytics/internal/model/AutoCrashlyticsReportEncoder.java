...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.of(BigAlbumStore.PhotoTagColumns.MODEL);
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.of(TapjoyConstants.TJC_NOTIFICATION_DEVICE_PREFIX);
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        ...
        private static final FieldDescriptor SIZE_DESCRIPTOR = FieldDescriptor.of(BigAlbumStore.PhotoColumns.SIZE);
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.of("name");
        private static final FieldDescriptor UUID_DESCRIPTOR = FieldDescriptor.of(UserBox.TYPE);
