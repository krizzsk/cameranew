...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private g<InstallationTokenResult> addGetAuthTokenListener() {
        h hVar = new h();
        addStateListeners(new GetAuthTokenListener(this.utils, hVar));
        return hVar.a();
    }

    private g<String> addGetIdListener() {
        h hVar = new h();
    ...
    */
    ...
    private void preConditionChecks() {
        q.g(getApplicationId(), APP_ID_VALIDATION_MSG);
        q.g(getProjectIdentifier(), PROJECT_ID_VALIDATION_MSG);
        q.g(getApiKey(), API_KEY_VALIDATION_MSG);
        q.b(Utils.isValidAppIdFormat(getApplicationId()), APP_ID_VALIDATION_MSG);
        q.b(Utils.isValidApiKeyFormat(getApiKey()), API_KEY_VALIDATION_MSG);
    }
    ...
    public g<Void> delete() {
        return j.c(this.backgroundExecutor, FirebaseInstallations$$Lambda$3.lambdaFactory$(this));
    }
    ...
    public g<String> getId() {
        ...
        g<String> addGetIdListener = addGetIdListener();
    ...
    @Override // com.google.firebase.installations.FirebaseInstallationsApi
    @NonNull
    public g<InstallationTokenResult> getToken(boolean z) {
        preConditionChecks();
        g<InstallationTokenResult> addGetAuthTokenListener = addGetAuthTokenListener();
    ...
    public static FirebaseInstallations getInstance(@NonNull FirebaseApp firebaseApp) {
        q.b(firebaseApp != null, "Null is not a valid value of FirebaseApp.");
