...
public class RangeSlider extends BaseSlider<RangeSlider, Object, Object> {
    ...
    private static List<Float> y0(TypedArray typedArray) {
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        this.h0 = rangeSliderState.minSeparation;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.minSeparation = this.h0;
        rangeSliderState.separationUnit = this.i0;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray h2 = k.h(context, attributeSet, R.styleable.RangeSlider, i2, BaseSlider.g0, new int[0]);
        int i3 = R.styleable.RangeSlider_values;
        if (h2.hasValue(i3)) {
            setValues(y0(h2.getResources().obtainTypedArray(h2.getResourceId(i3, 0))));
        }
        this.h0 = h2.getDimension(R.styleable.RangeSlider_minSeparation, 0.0f);
        h2.recycle();
    }
}
