...
public class MediaView extends FrameLayout {
    ...
    private ImageView.ScaleType f3443d;

    /* renamed from: e  reason: collision with root package name */
    private boolean f3444e;

    /* renamed from: f  reason: collision with root package name */
    private zzaee f3445f;
    ...
    public final synchronized void b(zzaee zzaeeVar) {
        this.f3445f = zzaeeVar;
        if (this.f3444e) {
            zzaeeVar.setImageScaleType(this.f3443d);
        }
    }

    public void setImageScaleType(ImageView.ScaleType scaleType) {
        this.f3444e = true;
        this.f3443d = scaleType;
        zzaee zzaeeVar = this.f3445f;
        if (zzaeeVar != null) {
