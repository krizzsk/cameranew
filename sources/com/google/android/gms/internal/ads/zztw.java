...
public final class zztw {
    ...
    public static final class zza extends zzelb<zza, zzb> implements zzemq {
        ...
        /* loaded from: classes2.dex */
        public enum EnumC0159zza implements zzelg {
            ...
            REQUEST_FAILED_TO_PROCESS_RESPONSE(CloseFrame.NOCODE),
            ...
            private static final zzelf<EnumC0159zza> zzes = new zzua();
            ...
            public final String toString() {
                return "<" + EnumC0159zza.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
            }
