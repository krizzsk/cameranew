...
public final class zzcal implements zzeqb<zzcam> {
    ...
    private zzcal(zzeqo<zzaxd> zzeqoVar, zzeqo<Context> zzeqoVar2, zzeqo<zzaxc> zzeqoVar3, zzeqo<View> zzeqoVar4, zzeqo<zzug.zza.EnumC0160zza> zzeqoVar5) {
        this.zzfwc = zzeqoVar;
    ...
    public static zzcal zzd(zzeqo<zzaxd> zzeqoVar, zzeqo<Context> zzeqoVar2, zzeqo<zzaxc> zzeqoVar3, zzeqo<View> zzeqoVar4, zzeqo<zzug.zza.EnumC0160zza> zzeqoVar5) {
