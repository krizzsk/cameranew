...
public final class zzkn {
    ...
    public static int zzc(CharSequence charSequence) {
        ...
        sb.append(i4 + IjkMediaMeta.AV_CH_WIDE_RIGHT);
        throw new IllegalArgumentException(sb.toString());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zzd(CharSequence charSequence, byte[] bArr, int i2, int i3) {
        return zza.zzd(charSequence, bArr, i2, i3);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static String zze(byte[] bArr, int i2, int i3) throws zzic {
        return zza.zzc(bArr, i2, i3);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ int zzh(byte[] bArr, int i2, int i3) {
        byte b = bArr[i2 - 1];
        int i4 = i3 - i2;
        if (i4 != 0) {
            if (i4 != 1) {
