...
public final class zzlb implements zzla {
    ...
    static {
        ...
        zzc = zzfeVar.zza("measurement.config.cache_time", AdvTimeUtils.MILLIS_OF_A_DAY);
        ...
        zzn = zzfeVar.zza("measurement.monitoring.sample_period_millis", AdvTimeUtils.MILLIS_OF_A_DAY);
        ...
        zzt = zzfeVar.zza("measurement.upload.stale_data_deletion_interval", AdvTimeUtils.MILLIS_OF_A_DAY);
        ...
        zzJ = zzfeVar.zza("measurement.upload.retry_time", TapjoyConstants.SESSION_ID_INACTIVITY_TIME);
