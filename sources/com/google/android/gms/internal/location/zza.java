...
public class zza implements IInterface {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final Parcel transactAndReadException(int i2, Parcel parcel) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        try {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void transactOneway(int i2, Parcel parcel) throws RemoteException {
        try {
