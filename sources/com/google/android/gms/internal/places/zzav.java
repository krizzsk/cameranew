...
public final class zzav<FieldDescriptorType extends zzax<FieldDescriptorType>> {
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i2 = 0; i2 < this.zzfj.zzcu(); i2++) {
            Map.Entry<FieldDescriptorType, Object> zzam = this.zzfj.zzam(i2);
    ...
    public final int zzav() {
        int i2 = 0;
        for (int i3 = 0; i3 < this.zzfj.zzcu(); i3++) {
            i2 += zze((Map.Entry) this.zzfj.zzam(i3));
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.zzfj.zzcv()) {
            i2 += zze((Map.Entry) entry);
        }
        return i2;
    }
    ...
    */
    ...
    public final void zzb(zzav<FieldDescriptorType> zzavVar) {
        for (int i2 = 0; i2 < zzavVar.zzfj.zzcu(); i2++) {
            zzd(zzavVar.zzfj.zzam(i2));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void zzb(zzaj zzajVar, zzef zzefVar, int i2, Object obj) throws IOException {
    ...
    public static int zzc(zzax<?> zzaxVar, Object obj) {
        ...
        if (zzaxVar.zzaz()) {
            ...
            if (zzaxVar.zzba()) {
                ...
                return zzaj.zzr(zzaw) + i2 + zzaj.zzz(i2);
            }
            for (Object obj3 : (List) obj) {
                i2 += zzb(zzax, zzaw, obj3);
            }
            return i2;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zzb(zzef zzefVar, int i2, Object obj) {
        int zzr = zzaj.zzr(i2);
        if (zzefVar == zzef.zzns) {
            zzbd.zzg((zzck) obj);
            zzr <<= 1;
