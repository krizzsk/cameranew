...
public class HevcDecoderConfigurationRecord {
    ...
    public int hashCode() {
        long j2 = this.general_profile_compatibility_flags;
        long j3 = this.general_constraint_indicator_flags;
        int i2 = ((((((((((((((((((((((((((((((((((((((((((this.configurationVersion * 31) + this.general_profile_space) * 31) + (this.general_tier_flag ? 1 : 0)) * 31) + this.general_profile_idc) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + ((int) (j3 ^ (j3 >>> 32)))) * 31) + this.general_level_idc) * 31) + this.reserved1) * 31) + this.min_spatial_segmentation_idc) * 31) + this.reserved2) * 31) + this.parallelismType) * 31) + this.reserved3) * 31) + this.chromaFormat) * 31) + this.reserved4) * 31) + this.bitDepthLumaMinus8) * 31) + this.reserved5) * 31) + this.bitDepthChromaMinus8) * 31) + this.avgFrameRate) * 31) + this.constantFrameRate) * 31) + this.numTemporalLayers) * 31) + (this.temporalIdNested ? 1 : 0)) * 31) + this.lengthSizeMinusOne) * 31;
        List<Array> list = this.arrays;
        return i2 + (list != null ? list.hashCode() : 0);
    }
    ...
    public void setAvgFrameRate(int i2) {
        this.avgFrameRate = i2;
    }

    public void setBitDepthChromaMinus8(int i2) {
        this.bitDepthChromaMinus8 = i2;
    }
    ...
    public void setGeneral_constraint_indicator_flags(long j2) {
        this.general_constraint_indicator_flags = j2;
    }

    public void setGeneral_level_idc(int i2) {
        this.general_level_idc = i2;
    }

    public void setGeneral_profile_compatibility_flags(long j2) {
        this.general_profile_compatibility_flags = j2;
    }

    public void setGeneral_profile_idc(int i2) {
        this.general_profile_idc = i2;
    }

    public void setGeneral_profile_space(int i2) {
        this.general_profile_space = i2;
    }
    ...
    public void setLengthSizeMinusOne(int i2) {
        this.lengthSizeMinusOne = i2;
    }

    public void setMin_spatial_segmentation_idc(int i2) {
        this.min_spatial_segmentation_idc = i2;
    }
    ...
    public void setNumTemporalLayers(int i2) {
        this.numTemporalLayers = i2;
    }

    public void setParallelismType(int i2) {
        this.parallelismType = i2;
    }
