...
public class ParamColorBalanceItem extends ParamItem {
    ...
    public ParamColorBalanceItem(String str, String str2, String str3, String str4) {
        super(str, str2, ParamItem.Type.ColorBalanceItem);
        this.defaultValue = "";
        this.noEffectValue = "";
        this.value = "";
    ...
    public ParamColorBalanceItem(String str, String str2, String str3, String str4, String str5, String str6) {
        super(str, str2, ParamItem.Type.ColorBalanceItem);
        this.defaultValue = "";
        this.noEffectValue = "";
        this.value = "";
