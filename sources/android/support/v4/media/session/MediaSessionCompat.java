    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (((playbackStateCompat == null ? 0L : playbackStateCompat.getActions()) & 128) != 0) {
                buildRccMetadata.addEditableKey(PGImageSDK.SDK_STATUS_DRAW);
            }
            if (bundle == null) {
            ...
            if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_USER_RATING)) {
                buildRccMetadata.putObject(PGImageSDK.SDK_STATUS_DRAW, (Object) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_USER_RATING));
            }
            return buildRccMetadata;
        }
