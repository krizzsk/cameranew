...
public class AdaptedFunctionReference implements q, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdaptedFunctionReference) {
            ...
            return this.isTopLevel == adaptedFunctionReference.isTopLevel && this.arity == adaptedFunctionReference.arity && this.flags == adaptedFunctionReference.flags && s.c(this.receiver, adaptedFunctionReference.receiver) && s.c(this.owner, adaptedFunctionReference.owner) && this.name.equals(adaptedFunctionReference.name) && this.signature.equals(adaptedFunctionReference.signature);
        }
        return false;
    }
