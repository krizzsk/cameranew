...
final class SlidingWindowKt$windowedIterator$1 extends RestrictedSuspendLambda implements kotlin.jvm.b.p<kotlin.sequences.g<? super List<? extends T>>, Continuation<? super kotlin.u>, Object> {
    ...
    SlidingWindowKt$windowedIterator$1(int i2, int i3, Iterator<? extends T> it, boolean z, boolean z2, Continuation<? super SlidingWindowKt$windowedIterator$1> continuation) {
    ...
    public final Object invoke(kotlin.sequences.g<? super List<? extends T>> gVar, Continuation<? super kotlin.u> continuation) {
        return ((SlidingWindowKt$windowedIterator$1) create(gVar, continuation)).invokeSuspend(kotlin.u.a);
    }
