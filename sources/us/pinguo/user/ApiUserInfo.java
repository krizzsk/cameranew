...
public class ApiUserInfo extends j.a.c.a.a<UserInfoResponse> {
    ...
    public void get(final j.a.c.b.d<UserInfoResponse> dVar) {
        ...
        RxVolley.create(builder.build()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1() { // from class: us.pinguo.user.a
            @Override // rx.functions.Action1
            public final void call(Object obj) {
                ApiUserInfo.this.b(dVar, (String) obj);
            }
        }, new Action1() { // from class: us.pinguo.user.b
            @Override // rx.functions.Action1
            public final void call(Object obj) {
