...
/* compiled from: ApiPhoneVerify.java */
/* loaded from: classes6.dex */
public class d0 extends j.a.c.a.a<UserInfoResponse> {
    private String a;
    private String b;
    private boolean c;
    ...
    public void get(final j.a.c.b.d<UserInfoResponse> dVar) {
        ...
        builder.withMethod(1).withUrl(t0.s).withEncrypt(true ^ us.pinguo.foundation.d.f10985d).addParams(hashMap);
        RxVolley.create(builder.build()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1() { // from class: us.pinguo.user.api.t
            @Override // rx.functions.Action1
            public final void call(Object obj) {
                d0.this.b(dVar, (String) obj);
            }
        }, new Action1() { // from class: us.pinguo.user.api.s
            @Override // rx.functions.Action1
            public final void call(Object obj) {
                d0.this.d(dVar, (Throwable) obj);
            }
        });
    }
}
