...
public class w extends j.a.c.a.a<UserInfoResponse> {
    private String a;
    ...
    public void get(final j.a.c.b.d<UserInfoResponse> dVar) {
        ...
        RxVolley.create(builder.build()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1() { // from class: us.pinguo.user.api.b
            @Override // rx.functions.Action1
            public final void call(Object obj) {
                w.this.b(dVar, (String) obj);
            }
        }, new Action1() { // from class: us.pinguo.user.api.a
            @Override // rx.functions.Action1
            public final void call(Object obj) {
                w.this.d(dVar, (Throwable) obj);
            }
        });
    }
}
