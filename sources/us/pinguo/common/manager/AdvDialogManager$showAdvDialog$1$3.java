...
@DebugMetadata(c = "us.pinguo.common.manager.AdvDialogManager$showAdvDialog$1$3", f = "AdvDialogManager.kt", i = {}, l = {60}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes4.dex */
public final class AdvDialogManager$showAdvDialog$1$3 extends SuspendLambda implements p<m0, Continuation<? super u>, Object> {
    ...
    public AdvDialogManager$showAdvDialog$1$3(FragmentActivity fragmentActivity, AdvDialogManager advDialogManager, AdvItem advItem, Continuation<? super AdvDialogManager$showAdvDialog$1$3> continuation) {
    ...
    public final Continuation<u> create(Object obj, Continuation<?> continuation) {
        return new AdvDialogManager$showAdvDialog$1$3(this.$activity, this.this$0, this.$advItem, continuation);
    }

    @Override // kotlin.jvm.b.p
    public final Object invoke(m0 m0Var, Continuation<? super u> continuation) {
        return ((AdvDialogManager$showAdvDialog$1$3) create(m0Var, continuation)).invokeSuspend(u.a);
    }
        ...
        if (fragmentActivity != null && !fragmentActivity.isFinishing()) {
            ...
            if (!(homeAdvDialog != null && homeAdvDialog.b0())) {
                ...
                if (homeAdvDialog2 != null) {
                    ...
                    h.a.L("camerafragment", advItem.advId, "show");
