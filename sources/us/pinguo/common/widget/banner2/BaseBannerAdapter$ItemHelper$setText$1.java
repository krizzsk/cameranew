...
final class BaseBannerAdapter$ItemHelper$setText$1 extends Lambda implements l<View, u> {
    final /* synthetic */ CharSequence $text;
    final /* synthetic */ int $viewId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    BaseBannerAdapter$ItemHelper$setText$1(CharSequence charSequence, int i2) {
        super(1);
