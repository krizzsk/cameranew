...
final class StaticStickerController$gotoAdvanceAdjust$1$3 extends Lambda implements kotlin.jvm.b.l<MagnifierLayout, kotlin.u> {
    final /* synthetic */ float $indicatorSize;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StaticStickerController$gotoAdvanceAdjust$1$3(float f2) {
        super(1);
