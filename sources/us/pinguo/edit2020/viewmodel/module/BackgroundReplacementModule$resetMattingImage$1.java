...
public final class BackgroundReplacementModule$resetMattingImage$1 extends Lambda implements q<String, Boolean, String, u> {
    ...
    public BackgroundReplacementModule$resetMattingImage$1(BackgroundReplacementModule backgroundReplacementModule, l<? super Boolean, u> lVar) {
        super(3);
    ...
    public final void invoke(String srcPathToUnity, boolean z, String maskPath) {
        ...
        this.this$0.h0(srcPathToUnity, z, maskPath, this.$callback, true);
    }
}
