...
final class AdjustModule$functions$1$function$1 extends Lambda implements kotlin.jvm.b.a<u> {
    final /* synthetic */ us.pinguo.edit2020.bean.a $func;
    final /* synthetic */ BaseAdjustType $type;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdjustModule$functions$1$function$1(BaseAdjustType baseAdjustType, us.pinguo.edit2020.bean.a aVar) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (nativeAdjustEntity2 != null) {
            ...
            nativeAdjustEntity2.setValue(String.valueOf((aVar.g() / aVar.i()) * 0.4f));
            nativeAdjustEntity = nativeAdjustEntity2;
        }
        a.getAdjust().clear();
