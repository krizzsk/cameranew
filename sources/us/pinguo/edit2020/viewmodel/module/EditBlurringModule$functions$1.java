...
final class EditBlurringModule$functions$1 extends Lambda implements t<Boolean, j, Float, Float, Float, Float, u> {
    public static final EditBlurringModule$functions$1 INSTANCE = new EditBlurringModule$functions$1();

    EditBlurringModule$functions$1() {
        super(6);
    }
    ...
    public final void invoke(boolean z, j func, float f2, float f3, float f4, float f5) {
        ...
        UnityEditCaller.Blur.updateBlurBaseInfos(z ? 3 : 1, l2.m(), (l2.e() - ((f4 - f2) * 0.5f)) / f2, 1 - ((l2.f() - ((f5 - f3) * 0.5f)) / f3), l2.i() / f2, l2.j() / f3, l2.k() / f2, l2.l() / f3, 0.0f, 0.0f);
    }
}
