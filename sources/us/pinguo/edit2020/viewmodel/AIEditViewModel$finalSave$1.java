...
final class AIEditViewModel$finalSave$1 extends Lambda implements l<String, u> {
    final /* synthetic */ l<String, u> $saveResult;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AIEditViewModel$finalSave$1(l<? super String, u> lVar) {
        super(1);
        ...
        if (us.pinguo.foundation.d.f10987f) {
            f.c(new Runnable() { // from class: us.pinguo.edit2020.viewmodel.a
                ...
                public final void run() {
                    AIEditViewModel$finalSave$1.m104invoke$lambda0(str);
                }
            });
        }
