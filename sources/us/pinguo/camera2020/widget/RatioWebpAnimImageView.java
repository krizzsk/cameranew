...
public class RatioWebpAnimImageView extends SimpleDraweeView {
    ...
    private final void l(Context context, AttributeSet attributeSet) {
        ...
        this.f9499i = obtainStyledAttributes.getFloat(R.styleable.RatioImageView_aspectRatio, 0.0f);
    ...
    public void onMeasure(int i2, int i3) {
        if (this.f9499i > 0.0f) {
            ...
            if (mode == 1073741824) {
                i3 = View.MeasureSpec.makeMeasureSpec((int) ((size / this.f9499i) + 0.5f), 1073741824);
            }
        }
        super.onMeasure(i2, i3);
        us.pinguo.common.log.a.k("mRatio = " + this.f9499i + " width = " + getMeasuredWidth() + "height = " + getMeasuredHeight(), new Object[0]);
    }
}
