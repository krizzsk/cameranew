...
public final class AfterCaptureBottomController$show$7 extends Lambda implements kotlin.jvm.b.l<View, kotlin.u> {
    final /* synthetic */ AfterCaptureBottomController this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: AfterCaptureBottomController.kt */
    /* renamed from: us.pinguo.camera2020.view.AfterCaptureBottomController$show$7$1  reason: invalid class name */
    /* loaded from: classes3.dex */
    public static final class AnonymousClass1 extends Lambda implements kotlin.jvm.b.a<kotlin.u> {
        ...
        public final void invoke2() {
            if (this.this$0.a.i() == AfterCaptureMode.VIDEO) {
                us.pinguo.foundation.utils.k0.a.a(R.string.video_saved);
            } else {
                us.pinguo.foundation.utils.k0.a.a(R.string.photo_saved);
            }
            this.this$0.m();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AfterCaptureBottomController$show$7(AfterCaptureBottomController afterCaptureBottomController) {
        super(1);
        this.this$0 = afterCaptureBottomController;
    }
    ...
    public final void invoke2(View it) {
        ...
        if (this.this$0.u()) {
            ...
            if (us.pinguo.repository2020.abtest.i.a.b()) {
                if ((!us.pinguo.camera2020.i.a.a.f() || us.pinguo.vip.proxy.b.b(us.pinguo.vip.proxy.b.a, false, 1, null) || this.this$0.a.g() || this.this$0.a.s()) ? false : false) {
                ...
                if (aVar.g(shutterButton.getContext(), bundle)) {
                    ...
                    us.pinguo.foundation.statistics.h.b.p(invoke.get(0), "preview_save", invoke.get(1), invoke.get(2), invoke.get(4), invoke.get(3), invoke.get(5), invoke.get(6), invoke.get(7));
                    return;
                }
            }
            this.this$0.m();
